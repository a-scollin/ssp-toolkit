...
export default class GrahamScan {
    ...
    getHull() {
        ...
        // AS :
        // Add points above the current node to bridge the gap to next node. 
        ...
        for (let i = 1; i < hull; i++) {
            ...
            y = (hull.filter(x => !new_hull.includes(x))).sort(sortFunction)[0][1]

            new_hull.push([x1, y])

            new_hull.push([x2, y])

            new_hull.push(hull[i])
